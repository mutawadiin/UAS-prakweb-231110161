    ...
    <div class="flex flex-1 min-h-0">
        ...
        <aside class="hidden md:flex flex-col w-64 bg-white shadow-lg z-30">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="/dashboard" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-background-light transition {{ request()->is('dashboard') ? 'bg-accent text-white' : 'text-primary-dark' }}">
                    <i class="fa-solid fa-gauge-high"></i> Dashboard
                </a>
                <a href="/rencana" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-background-light transition {{ request()->is('rencana*') ? 'bg-accent text-white' : 'text-primary-dark' }}">
                    <i class="fa-solid fa-list-check"></i> Rencana
                </a>
                <a href="/peserta" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-background-light transition {{ request()->is('peserta*') ? 'bg-accent text-white' : 'text-primary-dark' }}">
                    <i class="fa-solid fa-users"></i> Peserta
                </a>
                <a href="/perjalanan" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-background-light transition {{ request()->is('perjalanan*') ? 'bg-accent text-white' : 'text-primary-dark' }}">
                    <i class="fa-solid fa-route"></i> Perjalanan
                </a>
            </nav>
            <div class="mt-auto px-6 py-4 border-t text-xs text-gray-500">
                &copy; {{ date('Y') }} Rencana Liburan. All rights reserved.
            </div>
        </aside>
        <!-- End Sidebar -->
