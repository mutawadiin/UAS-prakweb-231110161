...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-lg p-8">
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('rencana.store')); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?>
        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\prakweb\UAS\aplikasi_rencana_liburan\resources\views/rencana/create.blade.php ENDPATH**/ ?>