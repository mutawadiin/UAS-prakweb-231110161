...
<div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-xl shadow p-6 flex items-center gap-4">
            ...
            <div>
                <div class="text-2xl font-bold"><?php echo e($rencanaCount); ?></div>
        ...
        <div class="bg-white rounded-xl shadow p-6 flex items-center gap-4">
            ...
            <div>
                <div class="text-2xl font-bold"><?php echo e($pesertaCount); ?></div>
        ...
        <div class="bg-white rounded-xl shadow p-6 flex items-center gap-4">
            ...
            <div>
                <div class="text-2xl font-bold"><?php echo e($perjalananCount); ?></div>
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Jumlah',
                data: [<?php echo e($rencanaCount); ?>, <?php echo e($pesertaCount); ?>, <?php echo e($perjalananCount); ?>],
                backgroundColor: [
                    'rgba(97, 165, 194, 0.7)',
                    'rgba(1, 79, 134, 0.7)',
                    'rgba(42, 111, 151, 0.7)'
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\prakweb\UAS\aplikasi_rencana_liburan\resources\views/dashboard.blade.php ENDPATH**/ ?>